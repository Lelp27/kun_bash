...
if( $mkDB ){
	docker exec minimap2 ./git/kun_bash/aporva/mkDB.sh
	}
else{}
docker exec minimap2 ./git/kun_bash/aporva/2.minimap2.sh
docker exec samtools ./git/kun_bash/aporva/3.sam_sort.sh
